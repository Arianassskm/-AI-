...
INSERT INTO "new_Medicine" ("approvalNumber", "batchNumber", "createdAt", "deleted", "deletedAt", "description", "expiryDate", "id", "image", "manufacturer", "name", "nameEn", "packageInfo", "specification", "storageCondition", "updatedAt", "userId") SELECT "approvalNumber", "batchNumber", "createdAt", "deleted", "deletedAt", "description", "expiryDate", "id", "image", "manufacturer", "name", "nameEn", "packageInfo", "specification", "storageCondition", "updatedAt", "userId" FROM "Medicine";
DROP TABLE "Medicine";
