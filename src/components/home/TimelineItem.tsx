...
export function TimelineItem({ 
  ...
  return (
    <div className="flex gap-2">
      <div className="w-10 text-gray-400 pt-4 text-xs">
        {reminder.time}
      </div>
      ...
      <div className="relative flex-1">
        ...
        <div className="relative">
          ...
          <div className="relative z-10 mt-4">
            ...
            {/* Content Card */}
            <div className={cn("ml-8 rounded-xl p-3 transition-all duration-300", getCardStyles())}>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  {reminder.type === 'expiration' && reminder.expirationDate && (
                  ...
                  {reminder.type === 'low_stock' && reminder.remainingQuantity !== undefined && (
                    <p className="mt-2 text-xs text-rose-600/90 flex items-center gap-1 bg-rose-50 px-2 py-1 rounded-md w-fit">
                      <Package className="h-3 w-3" />
                      剩余: {reminder.remainingQuantity}/{reminder.totalQuantity} {reminder.dosage.split(' ')[1]}
                    </p>
                  )}
                </div>
              </div>
