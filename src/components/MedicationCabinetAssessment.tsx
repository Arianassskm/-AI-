...
import { X, ChevronRight, Users, Thermometer, Box, DollarSign } from 'lucide-react';
...
export function MedicationCabinetAssessment({ isOpen, onClose }: MedicationCabinetAssessmentProps) {
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  <span>￥100</span>
                  <span className="text-blue-500 font-medium">￥{budget}</span>
                  <span>￥2000</span>
                </div>
              </div>
            </div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  <span>小型</span>
                  <span className="text-blue-500 font-medium">{storageSpace}格</span>
                  <span>大型</span>
                </div>
              </div>
            </div>
